...
REWARD_DROP_TOLERANCE = -80 # Determines how far can the reward drop before an episode is stopeed prematurely

early_stopping_patience = 300  # Stop training if no improvement for this many epochs
learning_iterations = 1

POLICY = Epsilon_Greedy_Policy(epsilon=1, decay=0.996)
...
while epoch <= EPOCHS and not stopped:
    ...
    if epoch % max(EPOCHS // 100, 1) == 0:
        ...
        video_filename = f'imgs/training_progress/epoch{epoch}.mp4'
